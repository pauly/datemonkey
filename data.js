// All the data in a big array, individual answers should be [ "Answer", year, "optional trivia (unused so far)", [ "optional wrong answer" ] ]
module.exports = [
  [
    'Best picture',
    [
      [ "12 Years a Slave", 2013, null, null, [ "American Hustle", "Captain Phillips", "The Wolf of Wall Street" ] ],
      [ "Argo", 2012, null, null, [ "Life of Pi", "Lincoln", "Django Unchained", "Les Miserables" ] ],
      [ "The Artist", 2011, null, "Black and white and silent", [ "War Horse" ] ],
      [ "King's Speech", 2010 ],
      [ "Hurt Locker", 2009 ],
      ...
      [ "Braveheart", 1995 ],
      [ "Forrest Gump", 1994, null, null, [ "Pulp Fiction" ]],
  ...
  [
    'Best actress',
    [
      [ "Cate Blanchett", 2013, null, "Blue Jasmine", [ "Amy Adams", "Sandra Bullock", "Judy Dench", "Meryl Streep" ]],
      [ "Jennifer Lawrence", 2012, null, "Silver Linings Playbook", [ "Jessica Chastain", "Emmanuelle Riva", "Quvenzhane Wallis", "Naomi Watts" ]],
      [ "Meryl Streep", 2011, null, "The Iron Lady", [ "Glenn Close", "Viola Davis", "Rooney Mara", "Michelle Williams" ]],
  ...
  [
    ...
    [
      [ 'Andy Murray', 2013, 'tennis' ],
      [ 'Bradley Wiggins', 2012, 'cycling' ],
      [ 'Mark Cavendish', 2011, 'horse racing' ],
      [ 'Tony McCoy', 2010, 'horse racing' ],
  ...
  [
    ...
    [
      ...
      [ "Edward IV", "1461-03-04", "1470-10-02" ],
      [ "Henry VI", "1470-10-30", "1471-04-11", "His second reign" ],
      [ "Edward IV", "1471-04-11", "1483-04-09", "His second reign" ],
      [ "Richard II", "1483-06-26", "1485-08-22" ],
      [ "Henry VII", "1485-08-22", "1509-04-21" ],
      [ "Henry VIII", "1509-04-21", "1547-01-28" ],
      [ "Edward VI", "1547-01-28", "1553-07-06" ],
      [ "Jane", "1553-07-10", "1553-07-19", "Lady Jane Grey" ],
    ],
  ...
  [
    ...
    [
       [ "Alabama", "Montgomery", "Birmingham, Alabama" ],
      [ 'No Woman No Cry', 1975, 'Bob Marley & The Wailers' ],
      [ 'The Boys Are Back in Town', 1976, 'Thin Lizzy' ],
      [ 'Pretty Vacant', 1977, 'Sex Pistols' ],
      [ 'Ever Fallen in Love (With Someone You Shouldn\'t\'ve)', 1978, 'The Buzzcocks' ],
      [ 'The Eton Rifles', 1979, 'The Jam' ],
      ...
      [ 'Love Wars', 1984, 'Womack & Womack' ],
      [ 'Never Understand', 1985, 'The Jesus & Mary Chain' ],
      [ 'Kiss', 1986, 'Prince' ],
      [ 'Sign o\' the Times', 1987, 'Prince' ],
      [ 'The Mercy Seat', 1988, 'Nick Cave' ],
      [ 'She Bangs the Drums', 1989, 'The Stone Roses' ],
      [ 'Groove Is in the Heart', 1990, 'Deee-lite' ],
      [ 'Higher Than the Sun', 1991, 'Primal Scream' ],
      [ 'The Drowners', 1992, 'Suede' ],
      [ 'Cannonball', 1993, 'The Breeders' ],
      [ 'Girls & Boys', 1994, 'Blur' ],
      [ 'Reverend Black Grape', 1995, 'Black Grape' ],
      [ 'Born Slippy', 1996, 'Underworld' ],
      [ 'Bitter Sweet Symphony', 1975, 'The Verve' ],
      ...
      [ 'There Goes the Fear', 2002, 'Doves' ],
      [ 'Crazy in Love', 2003, 'Beyoncé' ],
      [ 'Can\'t Stand Me Now', 2004, 'The Libertines' ],
      [ 'Hounds of Love', 2005, 'The Futureheads' ],
      [ 'Over and Over', 2006, 'Hot Chip' ],
      [ 'Golden Skans', 2007, 'Klaxons' ],
      [ 'Kids', 2008, 'MGMT' ],
      [ 'Zero', 2009, 'Yeah Yeah Yeahs' ],
      [ 'Spanish Sahara', 2010, 'Foals' ],
      [ 'Video Games', 2011, 'Lana Del Rey' ],
      [ 'Best of Friends', 2012, 'Palma Violets' ],
